describe BuntoOptionalFrontMatter::Generator do
  ...
  it "grabs the markdown converter" do
    expect(markdown_converter.class).to eql(Bunto::Converters::Markdown)
  end
  ...
  it "builds a page from a static file" do
    static_file = Bunto::StaticFile.new(site, site.source, "/", "readme.md")
    page = generator.send(:page_from_static_file, static_file)
    expect(page.class).to eql(Bunto::Page)
